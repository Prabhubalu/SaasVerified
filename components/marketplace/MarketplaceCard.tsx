        ...
        <div className="p-5 flex-1 flex flex-col">
          ...
          <div className="mt-auto pt-3 border-t border-gray-100 flex items-center gap-3">
            <button
              ...
              className="px-4 py-2 rounded-lg text-sm font-semibold border border-green-500 text-[#12b76a] bg-transparent transition-all border border-green-500 hover:text-green-700 group-hover:bg-[#12b76a] group-hover:text-white group-hover:border-[#12b76a] group-hover:hover:bg-green-700 whitespace-nowrap"
            >
              Get Recommendation
            </button>
            {vendor.website && (
              <button
                ...
                className="text-sm font-semibold text-gray-600 border border-gray-200 px-4 py-2 rounded-lg inline-flex items-center gap-2 transition-colors whitespace-nowrap  hover:text-gray-800 hover:bg-gray-300 group-hover:bg-gray-100 group-hover:text-gray-700"
              >
                Visit Website
