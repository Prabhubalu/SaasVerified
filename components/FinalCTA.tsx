...
export function FinalCTA() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative py-20 overflow-hidden rounded-tr-[120px]" style={{
        background: 'linear-gradient(to right, #f3e8ff, #dbeafe, #fef3c7)'
      }}>
      ...
      {/* Footer Section with Gradient Fade */}
      <div className="relative bg-gradient-to-b from-transparent via-transparent to-[#fafafa] pt-24 pb-0">
