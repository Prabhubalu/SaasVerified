              ...
              {showLogout ? (
                ...
                <>
                  <button 
                    ...
                    className="text-[#12b76a] px-3 md:px-4 lg:px-6 py-2 md:py-2.5 lg:py-3 text-xs md:text-sm lg:text-base font-normal hover:text-[#12b76a] hover:bg-[#12b76a]/10 hover:underline transition-all rounded-full whitespace-nowrap"
                  >
      ...
      {isOpen && (
        <div className="lg:hidden mt-2 bg-white/30 backdrop-blur-xl border border-white/20 rounded-2xl shadow-lg">
          <div className="pt-2 pb-3 space-y-1 px-4">
            <Link href="/buyers" className="block py-2 text-gray-700 hover:text-gray-900">
              Buyers
            </Link>
            <Link href="/vendors" className="block py-2 text-gray-700 hover:text-gray-900">
              Vendors
            </Link>
            <Link href="/marketplace" className="block py-2 text-gray-700 hover:text-gray-900">
              Marketplace
            </Link>
            <Link href="/verify" className="block py-2 text-gray-700 hover:text-gray-900">
              Verification
            </Link>
            ...
            <div className="pt-4 space-y-2">
              {showLogout ? (
                ...
                <>
                  ...
                  <Link href="/marketplace" className="w-full bg-[#12b76a] text-white px-4 py-3 rounded-full text-sm font-normal flex items-center justify-center gap-1.5 shadow-lg hover:bg-green-700 transition-colors">
                    <span>Find Your SaaS</span>
